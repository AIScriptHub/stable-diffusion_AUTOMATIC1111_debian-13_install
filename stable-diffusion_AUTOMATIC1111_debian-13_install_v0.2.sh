...
#
# Usage:
#   bash stable-diffusion_AUTOMATIC1111_debian-13_install_v0.2
#
...
#   10. Runs webui.sh, which will now install only the remaining, unproblematic
...
setup_tmpdir_on_disk() {
    ...
    local tmp_dir="/var/tmp/sd-webui-tmp-$USER"
